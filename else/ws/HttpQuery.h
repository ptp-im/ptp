...
private:
	CHttpQuery() {}
    static void _ApiStatus(CHttpConn *pHttpConn);
	...
	static void _PushNotice(const string& strAppKey, Json::Value &post_json_obj, CHttpConn *pHttpConn);
	static void _ServerStatus(CHttpConn *pHttpConn);
