...
namespace DB_PROXY {
    ...
    void GroupPreCreateReqProxy(CImPdu* pPdu, uint32_t conn_uuid){
        ...
        do{
            ...
            CModelGroup::getInstance()->GroupPreCreateReq(&msg, &msg_rsp, error);
        } while(false);
        ...
        pPduResp->SetServiceId(PTP::Common::S_GROUP);
        pPduResp->SetCommandId(PTP::Common::CID_GroupPreCreateRes);
    ...
    void GroupCreateReqProxy(CImPdu* pPdu, uint32_t conn_uuid){
        ...
        do{
            ...
            CModelGroup::getInstance()->GroupCreateReq(&msg, &msg_rsp, error);
        } while(false);
        ...
        pPduResp->SetSeqNum(pPdu->GetSeqNum());
        pPduResp->SetServiceId(PTP::Common::S_GROUP);
        pPduResp->SetCommandId(PTP::Common::CID_GroupCreateRes);
        CProxyConn::AddResponsePdu(conn_uuid, pPduResp);
    }
    ...
    void GroupGetListReqProxy(CImPdu* pPdu, uint32_t conn_uuid){
        ...
        do{
            ...
            CModelGroup::getInstance()->GroupGetListReq(&msg, &msg_rsp, error);
        } while(false);
        ...
        pPduResp->SetSeqNum(pPdu->GetSeqNum());
        pPduResp->SetServiceId(PTP::Common::S_GROUP);
        pPduResp->SetCommandId(PTP::Common::CID_GroupGetListRes);
        CProxyConn::AddResponsePdu(conn_uuid, pPduResp);
    }
    void GroupGetMembersListReqProxy(CImPdu* pPdu, uint32_t conn_uuid){
        ...
        do{
            ...
            CModelGroup::getInstance()->GroupGetMembersListReq(&msg, &msg_rsp, error);
        } while(false);
        ...
        pPduResp->SetSeqNum(pPdu->GetSeqNum());
        pPduResp->SetServiceId(PTP::Common::S_GROUP);
        pPduResp->SetCommandId(PTP::Common::CID_GroupGetMembersListRes);
        CProxyConn::AddResponsePdu(conn_uuid, pPduResp);
    }
    void GroupModifyReqProxy(CImPdu* pPdu, uint32_t conn_uuid){
        ...
        do{
            ...
            CModelGroup::getInstance()->GroupModifyReq(&msg, &msg_rsp, error);
        } while(false);
        ...
        pPduResp->SetCommandId(PTP::Common::CID_GroupModifyRes);
        CProxyConn::AddResponsePdu(conn_uuid, pPduResp);
    }
    void GroupUnreadMsgReqProxy(CImPdu* pPdu, uint32_t conn_uuid){
        ...
        do{
            ...
            CModelGroup::getInstance()->GroupUnreadMsgReq(&msg, &msg_rsp, error);
        ...
        pPduResp->SetSeqNum(pPdu->GetSeqNum());
        pPduResp->SetServiceId(PTP::Common::S_BUDDY);
        pPduResp->SetCommandId(PTP::Common::CID_GroupUnreadMsgRes);
        CProxyConn::AddResponsePdu(conn_uuid, pPduResp);
    }
