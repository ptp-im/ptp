...
void CHandlerMap::Init()
{
    ...
    // Login validate
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_ServerLoginReq), DB_PROXY::ServerLoginReqProxy));
    // users
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_BuddyGetALLReq), DB_PROXY::BuddyGetALLReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_BuddyGetListReq), DB_PROXY::BuddyGetListReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_BuddyModifyReq), DB_PROXY::BuddyModifyReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_BuddyQueryListReq), DB_PROXY::BuddyQueryListReqProxy));

    //buddy
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_BuddyModifyUpdatePair), DB_PROXY::BuddyModifyUpdatePairProxy));

    //group
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_GroupPreCreateReq), DB_PROXY::GroupPreCreateReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_GroupCreateReq), DB_PROXY::GroupCreateReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_GroupGetListReq), DB_PROXY::GroupGetListReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_GroupGetMembersListReq), DB_PROXY::GroupGetMembersListReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_GroupUnreadMsgReq), DB_PROXY::GroupUnreadMsgReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_GroupModifyReq), DB_PROXY::GroupModifyReqProxy));

    //msg
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_MsgReq), DB_PROXY::MsgReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_MsgReadAckReq), DB_PROXY::MsgReadAckReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_MsgGetMaxIdReq), DB_PROXY::MsgGetMaxIdReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_MsgGetByIdsReq), DB_PROXY::MsgGetByIdsReqProxy));
    m_handler_map.insert(make_pair(uint32_t(PTP::Common::CID_MsgUnNotify), DB_PROXY::MsgUnNotifyProxy));
...
//    m_handler_map.insert(make_pair(uint32_t(CID_LOGIN_REQ_QUERY_PUSH_SHIELD), DB_PROXY::doQueryPushShield));
    ...
    m_handler_map.insert(make_pair(uint32_t(CID_BUDDY_LIST_CHANGE_AVATAR_REQUEST), DB_PROXY::changeUserAvatarUrl));
