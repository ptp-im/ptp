...
{
    log("HandlePdu, cid: %d  , sid: %d ",pPdu->GetCommandId(),pPdu->GetServiceId());
...
void CMsgConn::_HandleLoginRequest(CImPdu* pPdu)
{
    ...
    log("addr: %s,pubKey: %s",address_hex.c_str(),pub_key_64_hex.c_str());
