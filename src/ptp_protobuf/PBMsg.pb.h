...
namespace google {
namespace protobuf {
template<> ::PBMsg::Msg* Arena::CreateMaybeMessage<::PBMsg::Msg>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace PBMsg {
...
class Msg : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:PBMsg.Msg) */ {
 public:
  Msg();
  virtual ~Msg();
  ...
  // @@protoc_insertion_point(class_scope:PBMsg.Msg)
 private:
...
inline bool Msg::is_online() const {
  // @@protoc_insertion_point(field_get:PBMsg.Msg.is_online)
  return is_online_;
}
inline void Msg::set_is_online(bool value) {
  set_has_is_online();
  is_online_ = value;
  // @@protoc_insertion_point(field_set:PBMsg.Msg.is_online)
}
