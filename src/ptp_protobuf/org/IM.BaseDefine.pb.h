...
enum OtherCmdID {
  ...
  CID_OTHER_IMRandomReq_REQ = 1845,
  CID_OTHER_IMRandomReq_RES = 1846,
  CID_OTHER_SYSTEM_ERROR_RES = 1847
};
bool OtherCmdID_IsValid(int value);
const OtherCmdID OtherCmdID_MIN = CID_OTHER_HEARTBEAT;
const OtherCmdID OtherCmdID_MAX = CID_OTHER_SYSTEM_ERROR_RES;
const int OtherCmdID_ARRAYSIZE = OtherCmdID_MAX + 1;

enum ResultType {
  RETURN_SEND_BUSINESS = -4,
  RETURN_SEND_ROUTE = -3,
  RETURN_SEND_CLIENT = -2,
  RETURN_OK = -1,
  ...
  REFUSE_SYSTEM_ERROR = 8,
  REFUSE_LOGIN_ERROR = 10,
  REFUSE_E_EMPTY_MSG = 11,
  REFUSE_E_MSG_TO0_LONG = 12,
  REFUSE_E_MSG_TOO_MUCH = 13,
  REFUSE_E_PARSE_PB_MSG = 14
};
bool ResultType_IsValid(int value);
const ResultType ResultType_MIN = RETURN_SEND_BUSINESS;
const ResultType ResultType_MAX = REFUSE_E_PARSE_PB_MSG;
