...
#ifndef PROTOBUF_INCLUDED_PB_2eGroup_2eproto
#define PROTOBUF_INCLUDED_PB_2eGroup_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_PB_2eGroup_2eproto 
...
class Group : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:PB.Group) */ {
 public:
  Group();
  virtual ~Group();
 ...
 private:
  ...
  bool is_online_;
  friend struct ::protobuf_PB_2eGroup_2eproto::TableStruct;
};
// ===================================================================
...
inline bool Group::is_online() const {
  // @@protoc_insertion_point(field_get:PB.Group.is_online)
  return is_online_;
}
inline void Group::set_is_online(bool value) {
  set_has_is_online();
  is_online_ = value;
  // @@protoc_insertion_point(field_set:PB.Group.is_online)
}
...
#endif  // PROTOBUF_INCLUDED_PB_2eGroup_2eproto
