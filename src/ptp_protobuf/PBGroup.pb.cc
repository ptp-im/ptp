...
static void InitDefaultsGroup() {
  ...
  {
    void* ptr = &::PBGroup::_Group_default_instance_;
    new (ptr) ::PBGroup::Group();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::PBGroup::Group::InitAsDefaultInstance();
}
...
Group::Group()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_PBGroup_2eproto::scc_info_Group.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:PBGroup.Group)
}
Group::Group(const Group& from)
  ...
  // @@protoc_insertion_point(copy_constructor:PBGroup.Group)
}
...
Group::~Group() {
  // @@protoc_insertion_point(destructor:PBGroup.Group)
  SharedDtor();
}
...
const Group& Group::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_PBGroup_2eproto::scc_info_Group.base);
  return *internal_default_instance();
}


void Group::Clear() {
// @@protoc_insertion_point(message_clear_start:PBGroup.Group)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:PBGroup.Group)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:PBGroup.Group)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:PBGroup.Group)
  return false;
#undef DO_
}
...
void Group::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:PBGroup.Group)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:PBGroup.Group)
}

size_t Group::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:PBGroup.Group)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:PBGroup.Group)
...
// @@protoc_insertion_point(class_specific_copy_from_start:PBGroup.Group)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::PBGroup::Group* Arena::CreateMaybeMessage< ::PBGroup::Group >(Arena* arena) {
  return Arena::CreateInternal< ::PBGroup::Group >(arena);
}
}  // namespace protobuf
}  // namespace google
