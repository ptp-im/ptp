...
constexpr SID SID_MIN = S_AUTH;
constexpr SID SID_MAX = S_SWITCH;
constexpr int SID_ARRAYSIZE = SID_MAX + 1;

const std::string& SID_Name(SID value);
template<typename T>
inline const std::string& SID_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SID>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SID_Name.");
  return SID_Name(static_cast<SID>(enum_t_value));
}
bool SID_Parse(
...
constexpr CID_AUTH CID_AUTH_MIN = CID_AuthLoginReq;
constexpr CID_AUTH CID_AUTH_MAX = CID_AuthCaptchaRes;
constexpr int CID_AUTH_ARRAYSIZE = CID_AUTH_MAX + 1;

const std::string& CID_AUTH_Name(CID_AUTH value);
template<typename T>
inline const std::string& CID_AUTH_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_AUTH>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_AUTH_Name.");
  return CID_AUTH_Name(static_cast<CID_AUTH>(enum_t_value));
}
bool CID_AUTH_Parse(
...
constexpr CID_BUDDY CID_BUDDY_MIN = CID_BuddyStatNotify;
constexpr CID_BUDDY CID_BUDDY_MAX = CID_BuddyQueryListRes;
constexpr int CID_BUDDY_ARRAYSIZE = CID_BUDDY_MAX + 1;

const std::string& CID_BUDDY_Name(CID_BUDDY value);
template<typename T>
inline const std::string& CID_BUDDY_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_BUDDY>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_BUDDY_Name.");
  return CID_BUDDY_Name(static_cast<CID_BUDDY>(enum_t_value));
}
...
constexpr CID_MSG CID_MSG_MIN = CID_MsgReq;
constexpr CID_MSG CID_MSG_MAX = CID_MsgUnNotify;
constexpr int CID_MSG_ARRAYSIZE = CID_MSG_MAX + 1;

const std::string& CID_MSG_Name(CID_MSG value);
template<typename T>
inline const std::string& CID_MSG_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_MSG>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_MSG_Name.");
  return CID_MSG_Name(static_cast<CID_MSG>(enum_t_value));
}
bool CID_MSG_Parse(
...
constexpr CID_GROUP CID_GROUP_MIN = CID_GroupPreCreateReq;
constexpr CID_GROUP CID_GROUP_MAX = CID_GroupGetMembersListRes;
constexpr int CID_GROUP_ARRAYSIZE = CID_GROUP_MAX + 1;

const std::string& CID_GROUP_Name(CID_GROUP value);
template<typename T>
inline const std::string& CID_GROUP_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_GROUP>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_GROUP_Name.");
  return CID_GROUP_Name(static_cast<CID_GROUP>(enum_t_value));
}
...
constexpr CID_FILE CID_FILE_MIN = CID_FileImgUploadReq;
constexpr CID_FILE CID_FILE_MAX = CID_FileImgDownloadRes;
constexpr int CID_FILE_ARRAYSIZE = CID_FILE_MAX + 1;

const std::string& CID_FILE_Name(CID_FILE value);
template<typename T>
inline const std::string& CID_FILE_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_FILE>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_FILE_Name.");
  return CID_FILE_Name(static_cast<CID_FILE>(enum_t_value));
}
bool CID_FILE_Parse(
...
constexpr CID_SERVER CID_SERVER_MIN = CID_ServerLoginReq;
constexpr CID_SERVER CID_SERVER_MAX = CID_ServerLoginRes;
constexpr int CID_SERVER_ARRAYSIZE = CID_SERVER_MAX + 1;

const std::string& CID_SERVER_Name(CID_SERVER value);
template<typename T>
inline const std::string& CID_SERVER_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_SERVER>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_SERVER_Name.");
  return CID_SERVER_Name(static_cast<CID_SERVER>(enum_t_value));
}
...
constexpr CID_OTHER CID_OTHER_MIN = CID_HeartBeatNotify;
constexpr CID_OTHER CID_OTHER_MAX = CID_CaptchaRes;
constexpr int CID_OTHER_ARRAYSIZE = CID_OTHER_MAX + 1;

const std::string& CID_OTHER_Name(CID_OTHER value);
template<typename T>
inline const std::string& CID_OTHER_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_OTHER>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_OTHER_Name.");
  return CID_OTHER_Name(static_cast<CID_OTHER>(enum_t_value));
}
...
constexpr CID_SWITCH CID_SWITCH_MIN = CID_SwitchPtpReq;
constexpr CID_SWITCH CID_SWITCH_MAX = CID_SwitchDevicesNotify;
constexpr int CID_SWITCH_ARRAYSIZE = CID_SWITCH_MAX + 1;

const std::string& CID_SWITCH_Name(CID_SWITCH value);
template<typename T>
inline const std::string& CID_SWITCH_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CID_SWITCH>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CID_SWITCH_Name.");
  return CID_SWITCH_Name(static_cast<CID_SWITCH>(enum_t_value));
}
...
constexpr QRCODE_TYPE QRCODE_TYPE_MIN = QRCODE_TYPE_MNEMONIC_SHARE;
constexpr QRCODE_TYPE QRCODE_TYPE_MAX = QRCODE_TYPE_NAME_CARD;
constexpr int QRCODE_TYPE_ARRAYSIZE = QRCODE_TYPE_MAX + 1;

const std::string& QRCODE_TYPE_Name(QRCODE_TYPE value);
template<typename T>
inline const std::string& QRCODE_TYPE_Name(T enum_t_value) {
  static_assert(::std::is_same<T, QRCODE_TYPE>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function QRCODE_TYPE_Name.");
  return QRCODE_TYPE_Name(static_cast<QRCODE_TYPE>(enum_t_value));
}
