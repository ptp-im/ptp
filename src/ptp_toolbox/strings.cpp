...
bool ptp_toolbox::strings::has_substring_icase(const std::string& substring, const std::string& source) {
    size_t cmp = compare(source, substring);
    return cmp != std::string::npos;
}

bool ptp_toolbox::strings::has_substring(const std::string& substring, const std::string& source) {
    return source.find(substring) != std::string::npos;
}
bool ptp_toolbox::strings::has_substring(char substring, const std::string& source) {
    return source.find(substring) != std::string::npos;
}
std::vector<std::string> ptp_toolbox::strings::split(const std::string& source, const std::string& delimiter) {
    if (delimiter.empty()) {
...
std::vector<std::string> ptp_toolbox::strings::split(const std::string& source, const char& delimiter) {
    std::stringstream ss;
    ss.str(source);
    std::string item;
...
std::vector<std::string> ptp_toolbox::strings::split_by_len(const std::string& src, size_t max) {
...
std::pair<std::string, std::string> ptp_toolbox::strings::split_pair(const std::string& source, const char& delimiter) {
...
std::pair<std::string, std::string> ptp_toolbox::strings::split_pair(const std::string& source,
...
std::string ptp_toolbox::strings::repeat(const std::string& in, size_t n) {
    std::stringstream ss;
...
std::string ptp_toolbox::strings::repeat(char in, size_t n) {
    std::stringstream ss;
    for (size_t i = 0; i < n; i++) {
        ss << in;
    }
...
std::string ptp_toolbox::strings::trim(const std::string& in) {
    std::string out = in;
    trim_ref(out);
    return out;
}
void ptp_toolbox::strings::trim_ref(std::string& in) {
...
void ptp_toolbox::strings::replace(const std::string& search, const std::string& replace, std::string& source) {
    source = substr_replace_ret(search, replace, source);
}
void ptp_toolbox::strings::substr_replace_all(const std::string& search, const std::string& replace, std::string& source) {
    source = substr_replace_all_ret(search, replace, source);
}
void ptp_toolbox::strings::substr_replace_all(const std::vector<std::string>& search, const std::vector<std::string>& replace,
                                          std::string& source) {
    source = substr_replace_all_ret(search, replace, source);
}

void ptp_toolbox::strings::substr_replace_all(const std::vector<std::string>& search, const std::string& replace, std::string& source) {
    substr_replace_all(search, std::vector<std::string>{replace}, source);
}

std::string ptp_toolbox::strings::substr_replace_ret(const std::string& search, const std::string& replace,
...
std::string ptp_toolbox::strings::substr_replace_all_ret(const std::string& search, const std::string& replace,
                                                     const std::string& source) {
...
std::string ptp_toolbox::strings::substr_replace_all_ret(const std::vector<std::string>& search,
...
std::string ptp_toolbox::strings::substr_replace_all_ret(const std::vector<std::string>& search, const std::string& replace, const std::string& source) {
    return substr_replace_all_ret(search, std::vector<std::string>{replace}, source);
}

void ptp_toolbox::strings::substr_remove(std::string& source, const std::string& removable) {
...
void ptp_toolbox::strings::substr_remove_all(std::string& source, std::vector<std::string> removables) {
    for (auto& replace : removables) {
        substr_remove(source, replace);
    }
}
std::string ptp_toolbox::strings::substr_inverse(const std::string& source, char whence) {
    strlen_t from;
    std::string out;
    if (~whence >= 0) {
...
std::string ptp_toolbox::strings::substr_inverse(const std::string& source, const std::string& begin, const std::string& end,
                                             long offset) {
...
std::string ptp_toolbox::strings::substr_inverse(const std::string& source, char begin, char end, long offset) {
    return substr_inverse(source, std::string(1, begin), std::string(1, end), offset);
}
std::string ptp_toolbox::strings::substr_inverse(const std::string& source, const std::string& begin) {
...
std::string ptp_toolbox::strings::substr_clip(const std::string& source, const std::string& search, size_t width,
                                          bool icase) {
...
std::string ptp_toolbox::strings::glue(const std::string& glue, const std::vector<std::string>& strings) {
    std::string out;
...
std::string ptp_toolbox::strings::to_string(std::ifstream& inputStream) {
    return std::string((std::istreambuf_iterator<char>(inputStream)), std::istreambuf_iterator<char>());
}
std::string ptp_toolbox::strings::to_lower_case(const std::string& s) {
...
std::string ptp_toolbox::strings::to_upper_case(const std::string& s) {
    std::stringstream tmp;
    for (char i : s) {
...
bool ptp_toolbox::strings::equals_icase(const std::string& s1, const std::string& s2) {
