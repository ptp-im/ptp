...
bool ptp_toolbox::strings::matches_pattern(const rxns::regex& pattern, const std::string& source) {
    rxns::smatch match;
    return rxns::regex_search(source, match, pattern);
}
bool ptp_toolbox::strings::matches_pattern(const std::string& pattern, const std::string& source) {
    return matches_pattern(rxns::regex(pattern, rxns::regex_constants::icase), source);
}
std::vector<std::vector<std::string>> ptp_toolbox::strings::find_all_pattern(const rxns::regex& pattern,
...
std::vector<std::vector<std::string>> ptp_toolbox::strings::find_all_pattern(const std::string& pattern,
                                                                         const std::string& source) {
    return find_all_pattern(rxns::regex(pattern, rxns::regex_constants::icase), source);
}
std::string ptp_toolbox::strings::find_pattern_first(const rxns::regex& pattern, const std::string& source) {
    rxns::smatch results;
    std::string result;
...
std::string ptp_toolbox::strings::find_pattern_first(const std::string& pattern, const std::string& source) {
    return find_pattern_first(rxns::regex(pattern, rxns::regex_constants::icase), source);
}
std::vector<std::string> ptp_toolbox::strings::find_pattern(const rxns::regex& rxPattern, const std::string& source) {
    rxns::smatch result;
...
std::vector<std::string> ptp_toolbox::strings::find_pattern(const std::string& pattern, const std::string& source) {
    return find_pattern(rxns::regex(pattern, rxns::regex_constants::icase), source);
}
bool ptp_toolbox::strings::num_is_integer(const std::string& input) {
    return rxns::regex_match(input, rxns::regex(R"(^[-]?[0-9eE+]+?$)"));
}
bool ptp_toolbox::strings::num_is_real(const std::string& input) {
