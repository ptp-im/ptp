...
bool ptp_toolbox::data::is_base64(uint8_t c) {
    return (isalnum(c) || (c == '+') || (c == '/'));
}

std::string ptp_toolbox::data::get_base64_chars() {
...
std::string ptp_toolbox::data::base64_encode(const std::string& raw_string) {
...
std::string ptp_toolbox::data::base64_decode(const std::string& encoded_string) {
...
std::vector<uint8_t> ptp_toolbox::data::base64_encode_bytes(const std::vector<uint8_t>& raw) {
    return to_bytes(base64_encode(to_ascii(raw)));
}
std::vector<uint8_t> ptp_toolbox::data::base64_decode_bytes(const std::vector<uint8_t>& encoded) {
    return to_bytes(base64_decode(to_ascii(encoded)));
}
std::vector<uint8_t> ptp_toolbox::data::base64_encode_chars(const std::vector<char>& raw) {
    return to_bytes(base64_encode(to_ascii(raw)));
}
std::vector<uint8_t> ptp_toolbox::data::base64_decode_chars(const std::vector<char>& encoded) {
    return to_bytes(base64_decode(to_ascii(encoded)));
}
