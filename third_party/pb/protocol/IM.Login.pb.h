...
// required bytes sign = 6;
inline bool IMLoginReq::has_sign() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void IMLoginReq::set_has_sign() {
  _has_bits_[0] |= 0x00000008u;
}
inline void IMLoginReq::clear_has_sign() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void IMLoginReq::clear_sign() {
  sign_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_sign();
}
inline const ::std::string& IMLoginReq::sign() const {
  // @@protoc_insertion_point(field_get:IM.Login.IMLoginReq.sign)
  return sign_.GetNoArena();
}
inline void IMLoginReq::set_sign(const ::std::string& value) {
  set_has_sign();
  sign_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:IM.Login.IMLoginReq.sign)
}
#if LANG_CXX11
inline void IMLoginReq::set_sign(::std::string&& value) {
  set_has_sign();
  sign_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:IM.Login.IMLoginReq.sign)
}
#endif
inline void IMLoginReq::set_sign(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_sign();
  sign_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:IM.Login.IMLoginReq.sign)
}
inline void IMLoginReq::set_sign(const void* value, size_t size) {
  set_has_sign();
  sign_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:IM.Login.IMLoginReq.sign)
}
inline ::std::string* IMLoginReq::mutable_sign() {
  set_has_sign();
  // @@protoc_insertion_point(field_mutable:IM.Login.IMLoginReq.sign)
  return sign_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* IMLoginReq::release_sign() {
  // @@protoc_insertion_point(field_release:IM.Login.IMLoginReq.sign)
  if (!has_sign()) {
    return NULL;
  }
  clear_has_sign();
...
inline void IMLoginReq::set_allocated_sign(::std::string* sign) {
  if (sign != NULL) {
    set_has_sign();
  } else {
    clear_has_sign();
  ...
  // @@protoc_insertion_point(field_set_allocated:IM.Login.IMLoginReq.sign)
}
